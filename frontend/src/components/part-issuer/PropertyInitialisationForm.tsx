...
const initialisationFormSchema = yup.object({
...
export type InitialisationFormValue = yup.InferType<typeof initialisationFormSchema>;

export type InitialisationFormSchemaProps = {
    values?: Partial<InitialisationFormValue>;
    minDistributionDate?: Date;
    onInitialisationRequest: (values: InitialisationFormValue) => unknown;
};

const PropertyInitialisationForm: React.FC<InitialisationFormSchemaProps> = ({
    values,
    minDistributionDate,
    onInitialisationRequest,
}) => {
    const {
        register,
        handleSubmit,
        ...
        setValue,
        setError,
    } = useForm<InitialisationFormValue>({ resolver: yupResolver(initialisationFormSchema) });
    ...
    const onSubmit = async (data: InitialisationFormValue) => {
        if (isSubmitting) {
...
export default PropertyInitialisationForm;
